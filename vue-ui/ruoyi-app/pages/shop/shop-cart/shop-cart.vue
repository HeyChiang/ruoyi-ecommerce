<template>
	<view class="container">
		...
		<view class="tui-edit-goods">
			...
			<view>
				<tui-button type="gray" :plain="true" shape="circle" width="160rpx" height="60rpx" :size="24" @click="editGoods">{{isEdit?"完成":"编辑"}}</tui-button>
			</view>
		</view>
		<!-- #endif -->
					...
					<template v-slot:content>
						<view class="tui-goods-item">
							<label class="tui-checkbox">
								<checkbox :value="item.id" :checked="item.selected" color="#CD1225"></checkbox>
							</label>
							<image src="https://img.alicdn.com/imgextra/i4/3280432178/O1CN01myRlPn1RxZEWRKL3i_!!3280432178-0-lubanu-s.jpg_800x800q90.jpg" class="tui-goods-img" />
				...
				<tui-swipe-action :actions="actions2">
					<template v-slot:content>
						<view class="tui-goods-item">
							...
							<image src="https://img.alicdn.com/imgextra/i4/3280432178/O1CN01myRlPn1RxZEWRKL3i_!!3280432178-0-lubanu-s.jpg_800x800q90.jpg" class="tui-goods-img opcity" />
							<view class="tui-goods-info">
		...
		<view class="tui-tabbar">
			<view class="tui-checkAll">
				<checkbox-group @change="checkAll">
					<label class="tui-checkbox">
						<checkbox :checked="isAll"  color="#CD1225"></checkbox>
			...
			buyChange(e) {
				...
				this.dataList.map(item => {
					...
					if (~this.cartIds.indexOf(item.id)) {
						console.log(this.cartIds,this.cartIds.indexOf(item.id),item.id)
						item.selected = true;
					} else {
						item.selected = false;
					}
