				...
				<block v-for="(item,index) in 2" :key="index">
					<tui-list-cell :hover="false" padding="0">
						<view class="tui-goods-item">
							<image src="https://img.alicdn.com/imgextra/i1/533497499/O1CN01OG4K5D25GahTBSEbr_!!0-item_pic.jpg_500x500q90.jpg" class="tui-goods-img"></image>
...
<script>
	import tPayWay from "@/components/tui-components/views/t-pay-way/ti-pay-way"
	export default {
		components: {
			tPayWay
		},
