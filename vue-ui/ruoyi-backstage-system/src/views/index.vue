      ...
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        ...
        <p>
          <el-button
            ...
            icon="el-icon-cloudy"
            plain
            @click="goTarget('https://github.com/HeyChiang/ruoyi-ecommerce')"
            >访问Github</el-button
          >
          <el-button
            size="mini"
        ...
        <el-card class="update-log">
          ...
          <div class="body">
            ...
            <p>
              ...
              <a href="https://qm.qq.com/cgi-bin/qm/qr?k=RiaJxjwjd1rG5PjILaOSmB_4BzTox-zV&jump_from=webapi" target="_blank"
                > 716802588</a
              >
            </p>
            <p>
